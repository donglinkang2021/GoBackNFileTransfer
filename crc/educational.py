...
def crc(data: int, poly: int) -> int:
    """
    A function to calculate the CRC of a given data and polynomial.
    Just for educational purposes. In real-world applications, our
    data and polynomial will be in bytes.
